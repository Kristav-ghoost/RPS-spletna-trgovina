    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            ...
            <form action="profile.php" method="POST" enctype="multipart/form-data"> 
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><input name="first_name" type="text" class="form-control" placeholder="first name" value="<?php echo $user->first_name ?>"></div>
                    <div class="col-md-6"><label class="labels">Surname</label><input name ="last_name" type="text" class="form-control" value="<?php echo $user->last_name ?>" placeholder="surname"></div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input name="phone" type="text" class="form-control" placeholder="" value="<?php echo $user->phone_number ?>"></div>
                ...
                <div class="mt-5 text-center"><input class="btn btn-primary profile-button" type="submit" name="poslji" value="Save Profile" /></div>
            </form>
            </div>
        </div>
    </div>
